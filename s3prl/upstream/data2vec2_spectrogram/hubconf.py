...
def data2vec2_spectrogram_url(*args, **kwargs):
    return data2vec2_spectrogram_custom(*args, **kwargs)


def data2vec2_spectrogram(refresh=False, *args, **kwargs):
    """
    The default model - Base
        refresh (bool): whether to download ckpt/config again if existed
    """
    return data2vec2_spectrogram_base_960(refresh=refresh, *args, **kwargs)


def data2vec2_spectrogram_base_960(refresh=False, *args, **kwargs):
    """
    The Base model
        refresh (bool): whether to download ckpt/config again if existed
    """
    ...
    return data2vec2_spectrogram_custom(refresh=refresh, *args, **kwargs)


def data2vec2_spectrogram_large_ll60k(refresh=False, *args, **kwargs):
    """
